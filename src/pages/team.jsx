  ...
  const teamData = {
    ...
    "Web Designer & Developers": [
      ...
      },
      {
        ...
        social: {
          website: "https://sumitrathore.web.app",
              ...
              >
                ...
                <div className="flex flex-wrap justify-center gap-8">
                  {members.map((member, index) => (
                    <div
                      key={`${category}-${index}`}
                      className="w-[280px] bg-gradient-to-b from-[#111] to-black rounded-xl overflow-hidden p-6 transform transition-all duration-500 hover:-translate-y-2 group"
                      style={{
